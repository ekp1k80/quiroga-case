...
export const STORYTELLING_DONE_GATES: StorytellingDoneGate[] = [
  ...
  { whenStoryNode: "casa-maria-cordoba", sceneId: "casa-maria-cordoba", advanceTo: "recapitulacion-maria" },
  { whenStoryNode: "recapitulacion-maria", sceneId: "recapitulacion-maria", advanceTo: "llegada-casa-beatriz" },
  { whenStoryNode: "llegada-casa-beatriz", sceneId: "llegada-casa-beatriz", advanceTo: "beatriz-abre-puerta" },
  { whenStoryNode: "beatriz-abre-puerta", sceneId: "beatriz-abre-puerta", advanceTo: "martin-entra-habitacion-eduardo" },
  { whenStoryNode: "martin-entra-habitacion-eduardo", sceneId: "martin-entra-habitacion-eduardo", advanceTo: "before-scan-qr3-chat" },
  { whenStoryNode: "hector-mom-final-call", sceneId: "hector-mom-final-call", advanceTo: "social-app-noise" },
  { whenStoryNode: "social-app-noise", sceneId: "social-app-noise", advanceTo: "eduardo-leaked" },
  { whenStoryNode: "eduardo-leaked", sceneId: "eduardo-leaked", advanceTo: "investigation" },
  { whenStoryNode: "investigation", sceneId: "investigation", advanceTo: "final-interview" },
  { whenStoryNode: "final-interview", sceneId: "final-interview", advanceTo: "credits" },
];
